...
<html lang="en">
  <head>
    ...
    <title>MenuScanOrder - Login Form</title>
          ...
          <div class="container">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav ms-auto">
                      ...
                      <li class="nav-item">
    <a class="nav-link <?= session()->get('isLoggedIn') ? 'active' : '' ?>" href="<?= session()->get('isLoggedIn') ? site_url('logout') : site_url('login') ?>">
        <?= session()->get('isLoggedIn') ? 'Login' : 'Logout' ?>
    </a>
</li>
    ...
    <section class="py-5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <h2 class="text-center mb-4">MenuScanOrder Login</h2>
                    ...
                    <form method="post" action="<?= base_url('login/confirm' ) ?>" >
                        ...
                        <button type="submit" class="btn btn-primary" href="<?= session()->get('isLoggedIn') ? site_url('items') : site_url('login') ?>">Login</button>
